...
_LOGO_PATH = Path(__file__).resolve().parent / "wavelogic_logo.png"
_LOGO_URI = "data:image/png;base64," + base64.b64encode(
    _LOGO_PATH.read_bytes()
).decode("ascii") if _LOGO_PATH.exists() else ""
...
.mso-logo {
    height: 46px; width: auto; border-radius: 8px; flex: 0 0 auto;
...
def render_header() -> None:
    st.markdown(
        ...
        <div class="mso-header">
            <img class="mso-logo" src="{_LOGO_URI}" alt="WaveLogic MSO logo">
            <div class="mso-title">
